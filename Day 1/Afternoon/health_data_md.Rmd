...
Finally, we're going to create some animated graphs using the new gganimate package. This version has just appeared on CRAN so you need to download it first and then install it.
